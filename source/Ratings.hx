...
class Ratings
{
    ...
    public static function CalculateRanking(score:Int,scoreDef:Int,nps:Int,maxNPS:Int,accuracy:Float,healthValue:Float):String
    {
        return 
        ...
        " | Health:" + " " + healthValue); 																			// Letter Rank
    }
}
